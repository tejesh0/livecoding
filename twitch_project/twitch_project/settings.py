"""
Django settings for twitch_project project.
...
SECRET_KEY = '3uti8@)jr%tsj(sn@h17+8(2i7dw^3vn-w3pv-!a2kk)vzw)_6'
...
ROOT_URLCONF = 'twitch_project.urls'
...
WSGI_APPLICATION = 'twitch_project.wsgi.application'
